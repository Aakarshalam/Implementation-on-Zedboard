...
HD_PWD='C:/Aakarsh Files/Implementation-on-Zedboard/Neg_exp_with_ip/negative_exponential/negative_exponential.runs/design_1_overall_axi_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_overall_axi_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_overall_axi_1_0.tcl
