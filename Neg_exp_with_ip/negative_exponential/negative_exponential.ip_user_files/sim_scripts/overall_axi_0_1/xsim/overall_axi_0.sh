...
#
# Script generated by Vivado on Thu Jun 05 03:46:03 +0530 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : overall_axi_0.sh
...
#
# Usage        : overall_axi_0.sh
#                overall_axi_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                overall_axi_0.sh [-reset_run]
#                overall_axi_0.sh [-reset_log]
#                overall_axi_0.sh [-help]
#
...
# script info
echo -e "overall_axi_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./overall_axi_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot overall_axi_0 xil_defaultlib.overall_axi_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim overall_axi_0 -key {Behavioral:sim_1:Functional:overall_axi_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb overall_axi_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./overall_axi_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: overall_axi_0.sh [-help]\n\
Usage: overall_axi_0.sh [-step]\n\
Usage: overall_axi_0.sh [-lib_map_path]\n\
Usage: overall_axi_0.sh [-reset_run]\n\
Usage: overall_axi_0.sh [-reset_log]\n\
Usage: overall_axi_0.sh [-keep_index]\n\
Usage: overall_axi_0.sh [-noclean_files]\n\n\
